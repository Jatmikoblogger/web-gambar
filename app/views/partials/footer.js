<div class="bg-gray-800 p-6 text-center text-white">
    <p class="m-4 p-4">
        ...
        <br>
        <span>Copyright &copy; <?= date('Y') ?>. By <a href="https://www.ariaatr.com/" target="_blank">AriaATR.com</a></span>
    </p>
</div>
...
<?php endif ?>
    <?php
    $inject_footer = file_get_contents($_SERVER['DOCUMENT_ROOT'] . '/inject-footer.txt');
    if ($inject_footer != '') {
        print_r($inject_footer);
    }
    ?>
